    ...
    <div class="mm-gauge-wrapper" :title="mmTooltip">
        ...
        <div class="progress-bar-bg">
            <div class="progress-bar-fill" 
                 ...
                 :class="mmColorClass"
            ></div>
            <!-- NO LIMIT MARKER AS REQUESTED -->
        </div>
    </div>

    <!-- Main Metrics Row (Flex Row strict synchronization) -->
    <div class="metrics-row">
        <!-- 1. Capital (Calculated with margin) - Not normally shown here but user asked for "Same metrics".
             However, Capital is usually fixed configuration. 
             If user wants 'Capital Wheel', 'Cash Used', 'Total Assignments', 'Cash Dispo', 'P/L', 'Prime'.
             I have 'Capital Used' in Gauge. I have 'P/L' in header.
             To respect "Strictly the same metrics in the same values", I will replicate the exact fields below.
        -->
        
        <!-- Trades Actifs (Requested addition) -->
...
.premium-badge {
    color: #0ea5e9; /* Blue like the screenshot badge text, though simple text here */
}
