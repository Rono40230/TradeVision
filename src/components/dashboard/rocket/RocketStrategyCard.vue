  ...
  <div class="rocket-strategy-card bento-card">
    ...
    <div class="metrics-row">
        ...
        <div class="metric-item item-premium">
            ...
            <span class="val">{{ formatCurrency(localExpectedPremium) }}</span>
        </div>
        
        <!-- Assignations (Wheel Only) -->
        <div class="metric-item item-assigned" v-if="strategy === 'wheel'">
             <span class="lbl">Assignations</span>
...
.metric-item .val.warn-text { color: #facc15; }
